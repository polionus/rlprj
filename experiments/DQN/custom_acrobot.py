...
class CustomAcrobotEnv(Env):
    ...
    def __init__(self, render_mode: Optional[str] = None, dt_multip = 1):
        ...
        self.dt_multip = dt_multip #MasoudAli

        self.dt = 0.2 * self.dt_multip # initially -->> # dt = 0.2
    ...
    def step(self, a):
        ...
        ns = rk4(self._dsdt, s_augmented, [0, self.dt], self.dt)  # Pass self.dt here
        ...
        reward = -1.0 * self.dt if not terminated else 0.0 #scale the reward with dt
